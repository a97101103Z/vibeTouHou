...
from routers import auth, render, assets, patterns, scores_router, publish, gallery_router, showcase_router, history_router, examples_router
...
app.include_router(showcase_router.router, prefix="/api", tags=["showcase"])
